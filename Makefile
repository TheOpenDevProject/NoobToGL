...
CXXFLAGS      = -m64 -pipe -g -rdynamic -O2 -std=c++0x -Wall -W -fPIC $(DEFINES)
...
DISTDIR = /media/reverseinverse/Data/FOSS/GLAttempt2/untitled/.tmp/untitled1.0.0
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS) /usr/local/lib/libglfw.so.3 -glfw3 -lGL -ldl 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		untitled.pro glad/glad.h \
		KHR/khrplatform.h main.cpp \
		glad.c
...
main.o: main.cpp glad/glad.h \
		KHR/khrplatform.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

glad.o: glad.c glad/glad.h \
		KHR/khrplatform.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o glad.o glad.c
